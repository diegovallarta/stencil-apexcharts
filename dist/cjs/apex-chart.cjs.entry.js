...
class chart {
    ...
    async componentDidLoad() {
        if (this.chartObj === null) {
            this.chartObj = new ApexCharts$1(this.chartRef, config(this.options, this.type, this.width, this.height, this.series));
    ...
    render() {
        return __chunk_1.h("div", { ref: el => (this.chartRef = el) });
    }
    static get watchers() { return {
        "options": ["optionsChanged"],
        "series": ["seriesChanged"]
    }; }
    static get style() { return "apex-chart{display:block}"; }
}

exports.apex_chart = chart;
